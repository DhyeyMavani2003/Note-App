let notes = [
	{
		id: new Date(),
		title: 'SAMPLE NOTE: Here goes the title',
		body: 'Here goes the note text which you enter. You can edit/delet this note, so feel free to play around with it.',
		bgColor: 'pink'
	}
]
...
const editNote = (noteDiv, editSave = false) => {
    ...
    if (editSave) {
        ...
        bodyP.contentEditable = false;
        editButton.onclick = () => editNote(noteDiv);
        deleteButton.onclick = () => deleteNoye(noteDiv);
    }
}
